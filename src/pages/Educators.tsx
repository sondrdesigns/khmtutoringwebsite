          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredEducators.map((educator, index) => (
              ...
              >
                ...
                <div className="p-6 pb-20 flex flex-col flex-1">
                  ...
                  <p className="text-muted-foreground italic text-sm mb-4 overflow-hidden flex-1" style={{ 
                    display: '-webkit-box',
                    WebkitLineClamp: 2,
                ...
                <div className="absolute bottom-4 right-4 left-4 text-muted-foreground group-hover:text-primary transition-colors text-xs font-medium text-right">
                  Click for full bio →
                </div>
              </button>
            ))}
