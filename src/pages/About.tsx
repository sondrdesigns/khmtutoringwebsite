...
const About = () => {
  return (
    <main className="pt-20">
      {/* Hero Section */}
      <section className="py-8 md:py-10 bg-gradient-to-br from-primary/10 via-primary/5 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="mb-3 md:mb-4 text-4xl md:text-5xl lg:text-6xl font-heading font-bold">
              About{" "}
              <span className="bg-gradient-to-r from-primary via-primary/80 to-primary text-transparent bg-clip-text font-bold">
                KHM | Expert Tutoring
              </span>
            </h1>
            <p className="text-primary/80 max-w-2xl mx-auto text-base md:text-lg font-medium">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            <div className="text-center mb-8">
              <div className="inline-block px-6 py-3 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full mb-4 border border-primary/30 shadow-lg">
                <span className="text-primary font-semibold text-lg">Our Mission</span>
              </div>
            </div>
            <div className="bg-gradient-to-br from-primary/5 to-transparent rounded-3xl p-8 md:p-10 border border-primary/20 shadow-lg">
              <p className="text-xl text-foreground leading-relaxed text-center mb-6">
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-primary/5 via-background to-primary/5 relative overflow-hidden">
        {/* Blue decorative background elements */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Our Story */}
            <div 
              className="group bg-gradient-to-br from-card to-primary/5 rounded-3xl p-8 border-2 border-primary/20 hover:border-primary transition-all duration-300 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2 animate-fade-in relative overflow-hidden"
              style={{ animationDelay: "0s" }}
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-primary/10 rounded-full blur-2xl" />
              <div className="relative z-10">
                <div className="mb-6 p-4 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl w-fit group-hover:bg-gradient-to-br group-hover:from-primary/30 group-hover:to-primary/20 transition-all shadow-lg">
      ...
      <section className="py-10 md:py-12 bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <div className="inline-block px-6 py-3 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full mb-6 border border-primary/30 shadow-lg">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  className="group flex items-start gap-4 p-8 bg-gradient-to-br from-card to-primary/5 rounded-2xl border-2 border-primary/20 hover:border-primary transition-all duration-300 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-1 animate-scale-in relative overflow-hidden"
                  style={{ animationDelay: `${0.3 + index * 0.1}s` }}
                >
                  <div className="absolute top-0 right-0 w-24 h-24 bg-primary/10 rounded-full blur-2xl" />
                  <div className="flex-shrink-0 p-3 bg-gradient-to-br from-primary/20 to-primary/10 rounded-full group-hover:bg-gradient-to-br group-hover:from-primary/30 group-hover:to-primary/20 group-hover:scale-110 transition-all shadow-lg relative z-10">
                    <Check className="w-6 h-6 text-primary" />
                  </div>
                  <p className="text-foreground leading-relaxed pt-2 text-lg relative z-10">
                    {benefit}
                  </p>
                </div>
              ))}
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-primary/5 via-background to-primary/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <div className="bg-gradient-to-br from-primary/20 via-primary/10 to-primary/5 rounded-3xl p-12 md:p-16 border-2 border-primary/30 shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-primary/20 rounded-full blur-3xl" />
              <div className="relative z-10">
                <div className="inline-block px-6 py-3 bg-gradient-to-r from-primary/30 to-primary/20 rounded-full mb-6 border border-primary/40 shadow-lg">
                ...
                <p className="text-lg text-foreground/80 leading-relaxed mb-10 max-w-2xl mx-auto">
